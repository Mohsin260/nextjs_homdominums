          ...
          <div className="ltn__utilize-menu-inner ltn__scrollbar">
            ...
            <div className="mini-cart-product-area ltn__scrollbar">
              <div className="mini-cart-item clearfix">
                ...
                <div className="mini-cart-info go-top">
                  <h6>
                    <Link href="/product-details">Wheel Bearing Retainer</Link>
                  </h6>
              ...
              <div className="mini-cart-item clearfix">
                ...
                <div className="mini-cart-info go-top">
                  <h6>
                    <Link href="/product-details">Brake Conversion Kit</Link>
                  </h6>
              ...
              <div className="mini-cart-item clearfix">
                ...
                <div className="mini-cart-info go-top">
                  <h6>
                    <Link href="/product-details">OE Replica Wheels</Link>
                  </h6>
              ...
              <div className="mini-cart-item clearfix">
                ...
                <div className="mini-cart-info go-top">
                  <h6>
                    <Link href="/product-details">Shock Mount Insulator</Link>
                  </h6>
            ...
            <div className="mini-cart-footer">
              ...
              <div className="btn-wrapper go-top">
                ...
                <Link href="/cart" className="theme-btn-2 btn btn-effect-2">
                  Checkout
                </Link>
              </div>
