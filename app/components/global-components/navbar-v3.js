                ...
                <div className="col-md-7">
                  <div className="ltn__top-bar-menu">
                    <ul style={{width: 'max-content'}}>
                      <li>
                        <Link href="g5plus@outlook.com support@beyot.com">
                          <i className="icon-mail" /> g5plus@outlook.com support@beyot.com
                        </Link>
                      </li>
                      <li>
                        <Link href="locations.html">
                          <i className="icon-placeholder" /> 118 Haward Amston Building St, CA, USA
                        </Link>
                      </li>
                      <li>
                        <Link href="tel:(+84) 388-969-888">
                    ...
                    <nav>
                      <div className="ltn__main-menu">
                        <ul>
                          ...
                          <li className="menu-icon">
                            <Link href="/blog-grid">Pre Luanch</Link>
                            <ul>
                              <li>
                                <Link href="/property-city/brampton/">Brampton</Link>
                              </li>
                              <li>
                                <Link href="/property-city/mississagua/">Mississagua</Link>
                              </li>
                              <li>
                                <Link href="/property-city/toronto">
                                Toronto
                                </Link>
                              </li>
                              <li>
                                <Link href="/property-city/vaughan">
                                Vaughan
                                </Link>
                              </li>
                            </ul>
